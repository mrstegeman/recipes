...
* Preheat the oven to 350°F. Position oven rack in the center of the oven. Cover a cookie sheet with
  tin foil.
* Wrap a piece of bacon around a date. Make sure the bacon seam is placed facing downward on the
  cookie sheet. Press firmly on the bacon-wrapped date, so it is less likely to unravel. Repeat
  until all of the dates are wrapped in bacon.
